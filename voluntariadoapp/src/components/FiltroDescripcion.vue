...
<ul class="list-group" v-else>
    ...
    <div class="col">       
     <li class="list-group-item">
            <div class="col">
                 <input type="text" placeholder="Buscar por descripcion" class="form-control" v-model="descripcion">
             </div>
     </li>
     </div>
     <div class="col">   
   ...
   import axios from "axios";
    ...
    import 'vue2-datepicker/index.css';
       ...
       export default {
        ...
        computed: {
            searchUser: function () {
                return this.Lconcat.filter((item) =>((item.descrip.includes(this.descripcion)) || (item.tarea.includes(this.descripcion))) );
